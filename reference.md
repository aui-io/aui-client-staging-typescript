...
<details><summary><code>client.agents.<a href="/src/api/resources/agents/client/Client.ts">deleteAgent</a>(agentId, { ...params }) -> void</code></summary>
<dl>
<dd>
...
**request:** `Apollo.DeleteAgentRequest` 
...
<details><summary><code>client.agentVersions.<a href="/src/api/resources/agentVersions/client/Client.ts">publishVersion</a>(agentId, versionId, { ...params }) -> Apollo.AgentVersionPublishResponse</code></summary>
<dl>
<dd>
...
**request:** `Apollo.PublishVersionRequest` 
...
<details><summary><code>client.projects.<a href="/src/api/resources/projects/client/Client.ts">getProject</a>(projectId, { ...params }) -> Apollo.Project</code></summary>
<dl>
<dd>
...
<details><summary><code>client.projects.<a href="/src/api/resources/projects/client/Client.ts">deleteProject</a>(projectId, { ...params }) -> void</code></summary>
<dl>
<dd>
...
**request:** `Apollo.IssueTokenRequest` 
