...
describe("Projects", () => {
    test("list_projects (1)", async () => {
        ...
        server
            ...
            .header("x-aui-organization-id", "x-aui-organization-id")
            .header("x-aui-user-id", "x-aui-user-id")
            .header("x-aui-source", "x-aui-source")
            .header("x-aui-network-id", "x-aui-network-id")
            .header("x-aui-account-id", "x-aui-account-id")
            .header("x-aui-network-category-id", "x-aui-network-category-id")
            .respondWith()
            .statusCode(200)
